...
class ValidatorTest extends TestCase
{
    ...
    public function getTests()
    {
        ...
        /**
         * Array of test specifiers, elements are:
         * 1. validation method.
         * 2. array of values to validate (most checks just take one parameter).
         * 3. Should validate pass?  True if yes, False if no.
         */
        return [
            ['string', ['value'], true],
            ['string', [''], true],
            ...
            [
                'isInstanceOfAny',
                [new Exception(), ['ArrayAccess', 'Countable']],
                false,
            ],
            ...
            [
                'ipv6',
                [new ToStringClass('2001:0db8:0000:0042:0000:8a2e:0370:7334')],
                true,
            ],
    ...
    public function getStringConversions(): array
    {
        return [
            ...
            [
                'eq',
                [new ToStringClass("XXX"), new ToStringClass("YYY")],
                'Expected a value equal to Webmozart\Assert\Tests\ToStringClass: "YYY". Got: Webmozart\Assert\Tests\ToStringClass: "XXX"',
            ],
            ['eq', [1, 2], 'Expected a value equal to 2. Got: 1'],
            ...
            [
                ...
                'Expected a value less than DateTime: "1999-01-01T00:00:00+00:00". Got: DateTime: "2020-01-01T00:00:00+00:00"',
            ],
        ];
    }
